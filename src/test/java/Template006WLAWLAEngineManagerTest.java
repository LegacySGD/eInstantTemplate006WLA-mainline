...
public class Template006WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template006WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template006WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template006WLAIW/InitOutcome.xml").getDocumentElement();
